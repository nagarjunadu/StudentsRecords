...
namespace StudentsRecords.Services
{
    public class NavigationService : INavigationService
    {
        ...
        public Task NavigateToEditStudentPage(Student student)
            => NavigateToPage<EditStudent>(student);

        public Task NavigateToAddStudentPage()
            => NavigateToPage<AddStudent>();

        public Task NavigateToAboutPage()
            => NavigateToPage<Views.AboutPage>();

        public Task NavigateToSupportPage()
            => NavigateToPage<Views.SupportPage>();
